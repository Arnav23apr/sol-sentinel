...
*Generated 2026-08-23 18:53 UTC by [sol-sentinel](https://github.com/Arnav23apr/sol-sentinel) - auto-updating, keyless, Python-stdlib-only.*

## Alerts

- 🔴 **Delinquent stake** (critical): Delinquent stake is 27.8 robust standard deviations above its 7-day baseline: a 2627.3% move to 0.60 % from a typical 0.02.
...
| Slot | 441M |
| Block height | 419M |
| Epoch | 1021 (34.48% complete, ~28.9h remaining) |
...
| Paying no priority fee | 20.90% of 5,203 sampled transactions (compared against the 5,000-lamport single-signature base fee, so multi-signature transactions are not counted here) |
| AMM write-lock congestion (150-slot window) | 22.70% of slots needed a priority fee (max 3.6M µlam/CU) |
...
| Delinquent stake | 0.60% |
| Total active stake | 430.8M SOL |
...
| Metric | Value |
|---|---|
| SOL price | $95.15 (+0.80% 24h) |
| Market cap | $55.50B (rank #7) |
| 24h volume | $4.46B |
...
| Jito MEV tips (24h) | $157.36K |
| **REV - Real Economic Value (24h)** | **$943.20K** (chain fees + MEV tips) |
...
|---|---|---|---|
| SPL Token | 60,000 (approx.) | 41.00% | 0.4 s |
| Pump.fun | 36,703 | 86.40% | 1.5 s |
| Raydium AMM v4 | 10,167 | 43.00% | 5.9 s |
| Orca Whirlpools | 4,500 | 50.40% | 13.2 s |
| Jupiter v6 | 2,740 | 28.50% | 21.7 s |

Median failure rate across the sampled programs: **43.00%** (range 28.50% to 86.40%). A median over five programs, not a chain-wide rate, and it varies widely between them.

Unwithdrawn inflation rewards sitting in the top 8 vote accounts: **35.30 SOL**.

## Exchange and large-holder balances

13.01M SOL ($1.24B) across 8 publicly-attributed accounts. Net **98K SOL (0.76%) moved onto exchanges** over the last 23.7 h.

| Account | Balance (SOL) | Value | Activity | Failed |
|---|---|---|---|---|
| Binance | 10.91M | $1.04B | 1.2/h | 0 |
| Binance (2) | 1.24M | $117.53M | 1.2K/h | 0 |
| Gate.io | 398.25K | $37.89M | 136.3/h | 0 |
| Bybit | 373.02K | $35.49M | 28/h | 0 |
| Kraken | 35.54K | $3.38M | 182.9/h | 0 |
| Coinbase (2) | 22.28K | $2.12M | 737.7/h | 0 |
| Bitget | 18.37K | $1.75M | 462.7/h | 0 |
| Coinbase | 17.01K | $1.62M | 653.4/h | 0 |

*Balances are re-verified on the chain every run and an account is dropped if it no longer holds a meaningful amount, so a stale label cannot become a false claim. Attribution is best-effort from public sources: Sentinel verifies what an account holds, never who controls it.*

## What moves together

Relationships between metrics, rather than each metric on its own. 7 of 117 tested pairs survive, over 611 observations.

*Method: Spearman rank correlation of period-over-period changes, with Benjamini-Hochberg false-discovery control at q=0.05 across all pairs tested. Changes are correlated rather than levels, because two series that both drift upward correlate near +1 whatever the real relationship. Rank correlation is used so a single outlier cannot manufacture a result.*

| Relationship | rho | n | p |
|---|---|---|---|
| DeFi TVL moves with xStocks AUM | +0.215 | 570 | 0.0000 |
| DEX volume moves with App fees | +0.210 | 570 | 0.0000 |
| Non-vote TPS moves with Slot time | +0.184 | 577 | 0.0000 |
| Total TPS moves with Slot time | +0.147 | 577 | 0.0004 |
| Slot time moves with AMM write-lock congestion | +0.143 | 536 | 0.0009 |
| Non-vote TPS moves with AMM write-lock congestion | +0.133 | 536 | 0.0021 |
| Total TPS moves with AMM write-lock congestion | +0.131 | 536 | 0.0024 |
...
|---|---|---|---|---|
| Chain fees (24h) | sampled blocks (RPC): 319.08K USD | DeFiLlama: 785.84K USD | -84.49% | *indicative*: 0.41x, within the order-of-magnitude band |
| SOL price | coingecko: 95.15 USD | Jupiter (on-chain DEX): 95.24 USD | -0.09% | agree |
