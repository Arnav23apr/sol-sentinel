...
*Generated 2026-08-11 16:45 UTC by [sol-sentinel](https://github.com/Arnav23apr/sol-sentinel) - auto-updating, keyless, Python-stdlib-only.*
...
| Slot | 439M |
| Block height | 417M |
| Epoch | 1015 (37.71% complete, ~31.3h remaining) |
| Lifetime transactions | 537.2B |
| Circulating supply | 582.5M SOL |
| Inflation (annual) | 3.70% |
| Median transaction fee | 5,477 lamports (about $0.00041) |
| Transaction fee p90 / p99 | 22,246 / 987,000 lamports |
| Paying base fee only | 18.40% of 8,011 sampled transactions |
| AMM write-lock congestion (150-slot window) | 28.00% of slots needed a priority fee (max 19.2M µlam/CU) |
...
| Metric | Value |
|---|---|
| SOL price | $74.90 (-1.80% 24h) |
| Market cap | $43.62B (rank #7) |
| 24h volume | $1.29B |
...
| Jito MEV tips (24h) | $139.62K |
| **REV - Real Economic Value (24h)** | **$820.17K** (chain fees + MEV tips) |
...
| xStocks 24h DEX volume | $24.87M |
| xStocks holders | 261.9K |
...
|---|---|---|---|
| Pump.fun | 94,858 (approx.) | 95.80% | 0.4 s |
| SPL Token | 89,835 (approx.) | 50.90% | 0.4 s |
| Jupiter v6 | 2,965 | 49.70% | 19.7 s |
| Raydium AMM v4 | 1,572 | 47.20% | 37.6 s |
| Orca Whirlpools | 1,063 | 70.80% | 54.8 s |

Median failure rate across the sampled programs: **50.90%** (range 47.20% to 95.80%). This is a consistent trend signal across these five programs, not a chain-wide rate.
...
|---|---|---|---|---|
| Chain fees (24h) | sampled blocks (RPC): 1.87M USD | DeFiLlama: 680.55K USD | +93.38% | agree (2.75x), *indicative* |
| SOL price | coingecko: 74.90 USD | Jupiter (on-chain DEX): 74.82 USD | +0.11% | agree |
