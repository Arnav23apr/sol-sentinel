...
*Generated 2026-09-24 20:35 UTC by [sol-sentinel](https://github.com/Arnav23apr/sol-sentinel) - auto-updating, keyless, Python-stdlib-only.*
...
| Slot | 450M |
| Block height | 428M |
| Epoch | 1041 (98.71% complete, ~0.4h remaining) |
| Lifetime transactions | 552.2B |
| Circulating supply | 587.6M SOL |
| Inflation (annual) | 3.63% |
| AMM write-lock congestion (150-slot window) | 18.00% of slots needed a priority fee (max 4.5M µlam/CU) |
...
| Top-5 / Top-10 / Top-20 stake share | 15.38% / 24.39% / 35.67% |
| Commission (stake-weighted, delegatable validators) | 3.81% |
| Stake on private (100% commission) validators | 23.80% |
...
| Metric | Value |
|---|---|
| SOL price | $116.77 (+2.24% 24h) |
| Market cap | $68.61B (rank #7) |
| 24h volume | $4.31B |
| ATH | $293.31 (-60.19% from ATH) |
...
| xStocks 24h DEX volume | $151.94M |
| xStocks holder positions | 631.9K (summed per ticker, so one wallet holding several is counted more than once) |
| Total RWA TVL on Solana | $542.89M |
...
|---|---|---|---|
| SPL Token | 76,271 (approx.) | 40.00% | 0.5 s |
| Pump.fun | 36,497 | 80.80% | 1.6 s |
| Orca Whirlpools | 8,886 | 41.40% | 6.6 s |
| Jupiter v6 | 7,246 | 74.80% | 8.2 s |
| Raydium AMM v4 | 2,061 | 27.20% | 28.9 s |

Median failure rate across the sampled programs: **41.40%** (range 27.20% to 80.80%). A median over five programs, not a chain-wide rate, and it varies widely between them.

Unwithdrawn inflation rewards sitting in the top 8 vote accounts: **35.40 SOL**.

## Exchange and large-holder balances

11.72M SOL ($1.37B) across 8 publicly-attributed accounts. Net **6K SOL (0.05%) moved off exchanges** over the last 21.3 h.

| Account | Balance (SOL) | Value | Activity | Failed |
|---|---|---|---|---|
| Binance | 9.94M | $1.16B | 0.2/h | 0 |
| Binance (2) | 1.19M | $139.13M | 1.5K/h | 0 |
| Gate.io | 254.13K | $29.68M | 194.7/h | 4 |
| Bybit | 219.11K | $25.58M | 120/h | 0 |
| Bitget | 35.08K | $4.10M | 81.2/h | 0 |
| Kraken | 34.10K | $3.98M | 289.6/h | 0 |
| Coinbase | 22.97K | $2.68M | 459.2/h | 0 |
| Coinbase (2) | 21.45K | $2.51M | 750/h | 0 |

*Balances are re-verified on the chain every run and an account is dropped if it no longer holds a meaningful amount, so a stale label cannot become a false claim. Attribution is best-effort from public sources: Sentinel verifies what an account holds, never who controls it.*

## What moves together

Relationships between metrics, rather than each metric on its own. 12 of 117 tested pairs survive, over 888 observations.
...
| DEX volume moves with App fees | +0.243 | 847 | 0.0000 |
| Non-vote TPS moves with Slot time | +0.213 | 854 | 0.0000 |
| Non-vote TPS moves with AMM write-lock congestion | +0.193 | 813 | 0.0000 |
| Total TPS moves with AMM write-lock congestion | +0.188 | 813 | 0.0000 |
| Total TPS moves with Slot time | +0.172 | 854 | 0.0000 |
| Total TPS moves with Program failure rate | +0.158 | 835 | 0.0000 |
| Non-vote TPS moves with Program failure rate | +0.157 | 835 | 0.0000 |
| Slot time moves with AMM write-lock congestion | +0.134 | 813 | 0.0001 |
| Share paying base fee only moves with Activity index | +0.118 | 818 | 0.0007 |
| SOL price moves with DeFi TVL | +0.118 | 888 | 0.0004 |
...
|---|---|---|---|---|
| SOL price | coingecko: 116.77 USD | Jupiter (on-chain DEX): 116.84 USD | -0.06% | agree |
