...
def headline_row(snapshot: dict, stale: Optional[list] = None) -> dict:
    ...
    return {
        ...
        "top5_stake_pct": g("validators", "top5_stake_pct"),
        "private_stake_pct": g("validators", "private_stake_pct"),
        "prio_congestion_pct": g("network", "prio_fee_nonzero_pct"),
        "sol_price": g("market", "price_usd"),
        "sol_change_24h": g("market", "change_24h_pct"),
        "market_cap": g("market", "market_cap_usd"),
        "volume_24h": g("market", "volume_24h_usd"),
        "tvl": g("defi", "tvl_usd"),
        ...
        "app_fees_24h": g("defi", "app_fees_24h_usd"),
        "xstocks_aum": g("tokenized", "xstocks_aum_usd"),
